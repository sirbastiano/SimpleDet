...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/Data_large/marine/Datasets/VDS2Raw/annotations/test__band_8.json',
        data_prefix=dict(img='imgs/'),
        data_root='/Data_large/marine/Datasets/VDS2Raw/',
...
test_evaluator = dict(
    ...
    metric='bbox',
    outfile_prefix=
    '/Data_large/marine/PythonProjects/MMDET/checkpoints/Sentinel/Special/BS_3/LR_0.0005/IMG_2048/BANDS__b8/42_Optim_SGD/test_results',
    type='CocoMetric')
test_pipeline = [
    dict(
        backend_args=None,
...
train_cfg = dict(max_epochs=130, type='EpochBasedTrainLoop', val_interval=1)
train_dataloader = dict(
    batch_sampler=dict(type='AspectRatioBatchSampler'),
    batch_size=3,
    dataset=dict(
        ann_file=
        '/Data_large/marine/Datasets/VDS2Raw/annotations/train__band_8.json',
        backend_args=None,
        data_prefix=dict(img='imgs/'),
        data_root='/Data_large/marine/Datasets/VDS2Raw/',
        filter_cfg=dict(filter_empty_gt=True),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/Data_large/marine/Datasets/VDS2Raw/annotations/val__band_8.json',
        backend_args=None,
        data_prefix=dict(img='imgs/'),
        data_root='/Data_large/marine/Datasets/VDS2Raw/',
        filter_cfg=dict(filter_empty_gt=True),
    ...
    sampler=dict(shuffle=False, type='DefaultSampler'))
val_evaluator = dict(
    ann_file='/Data_large/marine/Datasets/VDS2Raw/annotations/val__band_8.json',
    backend_args=None,
    format_only=False,
    metric='bbox',
    type='CocoMetric')
...
work_dir = '/Data_large/marine/PythonProjects/MMDET/checkpoints/Sentinel/Special/BS_3/LR_0.0005/IMG_2048/BANDS__b8/42_Optim_SGD'
