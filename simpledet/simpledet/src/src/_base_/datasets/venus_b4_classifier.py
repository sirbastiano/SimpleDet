...
metainfo = {
    ...
    'palette': [
        (220, 20, 60),(119, 11, 32), (0, 0, 142), (0, 0, 230),(220, 0, 230),
    ]
}
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/coarse_classifier/train.json',
        data_prefix=dict(img='ds_L0/coarse_band_4/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file='annotations/coarse_classifier/val.json',
        data_prefix=dict(img='ds_L0/coarse_band_4/'),
        test_mode=True,
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        metainfo=metainfo,
        ann_file=data_root + 'annotations/coarse_classifier/test.json',
        data_prefix=dict(img='ds_L0/coarse_band_4/'),
        test_mode=True,
        filter_cfg=dict(filter_empty_gt=True), # , min_size=32
        pipeline=test_pipeline))
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'annotations/coarse_classifier/val.json',
    metric='bbox',
    format_only=False,
    backend_args=backend_args)
