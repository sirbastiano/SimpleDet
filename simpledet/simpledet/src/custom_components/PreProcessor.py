...
# ImgDataPreProcessor from mmengine
class CustomImgDataPreprocessor(BaseDataPreprocessor):
    """Custom image pre-processor for normalization and padding.

    Inherits from ImgDataPreprocessor but removes BGR to RGB conversion.
    """
    ...
    def forward(self, data: dict, training: bool = False) -> Union[dict, list]:
        """Performs normalization and padding based on ``BaseDataPreprocessor``.

        Args:
            data (dict): Data sampled from the dataset.
...
class MyPrePro(CustomImgDataPreprocessor):
