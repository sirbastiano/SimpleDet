...
def parse_args():
    ...
    parser.add_argument('--band', type=parse_band_list, help='The band list num to train(list)', default='[10]')
    ...
    parser.add_argument('--sensor', type=str, default='VENUS', help='Sensor')
